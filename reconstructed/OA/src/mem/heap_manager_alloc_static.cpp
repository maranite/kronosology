 ...
 * +0x24.. handle table, +0x1e8498/+0x1e84a0/+0x1e84a4/+0x1e84a8
 * heapBase/heapSize/cursor/reservedSize) -- a mechanical byte-offset
 * transliteration of the ALREADY ground-truthed class body, not a fresh
 * re-disassembly, so it is guaranteed to stay behaviorally identical to
 * it. Every field here is accessed as a plain 4-byte `unsigned int`
...
#define HM_OFF_CURSOR      0x1e84a4ul

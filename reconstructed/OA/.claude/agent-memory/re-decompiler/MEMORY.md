...
- [STG value-getter family (~2300 methods, ~180 classes)](stg_value_getter_family.md) — huge codebase-wide Get*(ctx)->STGConvertedParam& pattern; 11 classes done (668 methods), shift-then-mask bitfield shape + "Get*/Set*"-prose */-gotcha added, ~157 classes pending

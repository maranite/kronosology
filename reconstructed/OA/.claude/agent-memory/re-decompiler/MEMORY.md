...
- [STG value-getter family (~2300 methods, ~180 classes)](stg_value_getter_family.md) — huge codebase-wide Get*(ctx)->STGConvertedParam& pattern; 8 classes done (592 methods), gen_oa_manifest.py DEF_RE paren + literal-*/-in-prose gotchas documented, ~160 classes pending

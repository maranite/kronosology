...
- [STG value-getter family (~2300 methods, ~180 classes)](stg_value_getter_family.md) — huge codebase-wide Get*(ctx)->STGConvertedParam& pattern; 14 classes done (757 methods), virtual-call-mediated-but-trivial base pointer + byte-width ctx-index + .h-file DEF_RE gotcha added, ~154 classes pending

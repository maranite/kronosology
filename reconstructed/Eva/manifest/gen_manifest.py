...
RECONSTRUCTED = {
    ...
    # -- round 54 (2026-07-29, solo): CFileOperation 23-method batch --
    "083c5d00",  # CFileOperation::Get1MMemory()
    "083c5d10",  # CFileOperation::Get900KMemory()
    "083c6700",  # CFileOperation::IsDirectExecCommand(EFileOpMsg)
    "083c6050",  # CFileOperation::EnableDirectIOCall(int)
    "083c7440",  # CFileOperation::SetForceDiskChangeTestMode(int)
    "083d0a90",  # CFileOperation::EnableWaitPIDSignal(int)
    "083d0aa0",  # CFileOperation::SetWaitTimeAfterSync(int)
    "083c7420",  # CFileOperation::SetForceDiskChangeTestEvent()
    "083c7430",  # CFileOperation::GetForceDiskChangeTestEvent()
    "083c6060",  # CFileOperation::Readblk(EDevice_Id,char*,ulong,ushort)
    "083c6070",  # CFileOperation::Writeblk(EDevice_Id,char const*,ulong,ushort)
    "083c6f80",  # CFileOperation::SetAsUsedScsiGenericNo(int,int)
    "083c7050",  # CFileOperation::SetAsUsedUSBDirectDeviceId(int,int)
    "083c71c0",  # CFileOperation::SetAsUsedUSBDirectDeviceIndex(int,int)
    "083c6b30",  # CFileOperation::GetUSBDirectAccessDeviceIndex(EDevice_Id)
    "083c6b50",  # CFileOperation::GetCDDeviceIndex(EDevice_Id)
    "083d0ab0",  # CFileOperation::SetDiskInfoDirty(EDevice_Id)
    "083d0ad0",  # CFileOperation::GetDiskInfoDirty(EDevice_Id)
    "083c7400",  # CFileOperation::GetUSBDiskNumber(int)
    "083c73d0",  # CFileOperation::SetUSBDiskNumber(int,int)
